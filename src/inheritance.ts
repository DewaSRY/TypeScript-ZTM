...
export abstract class Sorter{
    abstract compare(leftHeand:number,rightHeaand:number):boolean;
    abstract swap(leftHeand:number,rightHeaand:number):void;
...
export class CaracterCollection extends Sorter{
    constructor(
        public data:string
    ){
        super()
